...
class UiFlowContractTests(unittest.TestCase):
    ...
    def test_market_overview_starts_with_indices_breadth_and_rsi_rankings(self):
        ...
        for element_id in ("market-rsi-leader", "index-grid", "market-overview-breadth", "rsi-top-body", "rsi-bottom-body"):
        ...
        self.assertIn("useRsiFallback", self.app)
        self.assertIn("slice(0, 6)", self.app)
    ...
    def test_sector_and_industry_tables_have_internal_scroll_and_pinned_spy_rows(self):
        ...
        self.assertIn('<colgroup><col class="col-rank"><col class="col-etf"><col class="col-industry"><col class="col-rsi"><col class="col-delta"><col class="col-delta"><col class="col-delta"><col class="col-holdings"></colgroup>', self.page)
        self.assertNotIn('<th scope="col">状态</th>', self.page)
        self.assertIn('<td colspan="8">', self.app)
        self.assertNotIn('趋势（MA150）', self.page)
    ...
    def test_index_cards_default_to_intraday_and_hover_to_month(self):
        ...
        self.assertIn("never synthesize", self.app)
        self.assertIn("周末数据源已提供", self.app)
        ...
        self.assertIn('hasIntraday ? "当日 · 5M 面积图" : "近 1 个月日线"', self.app)
